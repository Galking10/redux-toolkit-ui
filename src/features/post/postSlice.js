...
export const deletePostById = createAsyncThunk('posts/removePostById', 
...
export const postSlice = createSlice({
    ...
    extraReducers: {
        [getPosts.fulfilled]: ()=> console.log('getPosts: fulfield'),
        [getPosts.pending]: ()=> console.log('getPosts: pending'),
        [getPosts.rejected]: ()=> console.log('getPosts: rejected'),
        [deletePostById.fulfilled]: ()=> console.log('deletePostById: fulfield'),
